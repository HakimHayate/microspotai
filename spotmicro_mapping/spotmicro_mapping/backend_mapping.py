...
from spotmicro_mapping.pathfinding import PathFinding
from spotmicro_mapping.icp_point2line import icp_point2line
...
class SLAMBackendNode(Node):
    ...
    def keyframe_callback(self, msg):
        ...
        if self.last_node_id is None:
            ...
            self.get_logger().info(f'current pose {pose_optimized}')
        ...
        # Gloabl optimization turned off because not working properly
