...
class GUI:
    def __init__(self, root, node):
        ...
        self.slider1 = tk.Scale(self.root, from_=-0.6, to=0.60, orient='horizontal', resolution=0.0001, command=self.update1)
        ...
        self.slider2 = tk.Scale(self.root, from_=-0.6, to=0.6, orient='horizontal', resolution=0.0001, command=self.update2)
        ...
        self.slider3 = tk.Scale(self.root, from_=0, to=0.60, orient='horizontal', resolution=0.0001, command=self.update3)
